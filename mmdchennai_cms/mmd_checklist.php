                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php">Downloads</a></li>
                ...
                <div class="modal-header" style=" border-bottom: 1px solid #e8e8e8;">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <h3 class="text-center">Add Main</h3>
                            </div>
                            <div class="col-lg-1">
                ...
                <div class="modal-header" style=" border-bottom: 1px solid #e8e8e8;">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <h3 class="text-center">Edit Main</h3>
                            </div>
                            <div class="col-lg-1">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
    ...
    <script>
        ...
        function get_dept() {
            ...
            $.ajax({
                ...
                // dataType: "json",
                url: 'webservice/get_checklist.php',
                data: data,
