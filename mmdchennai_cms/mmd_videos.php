        ...
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                <div class="modal-header" style=" border-bottom: 1px solid #e8e8e8;">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <h3 class="text-center">Add Videos</h3>
                            </div>
                            <div class="col-lg-1">
                ...
                <div class="modal-body" style="padding-top:10px;">
                    ...
                    <form id="addvideos-form" data-parsley-validate="">
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="add_videos(this.value);" id="subLang">Submit</button>
