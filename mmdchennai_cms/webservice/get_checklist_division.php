...
$get_dept_value = "select * from mst_checklist_dept where dept_id =$dept_id";
$result_dept_value = pg_query($db, $get_dept_value);
$get_row  = pg_fetch_array($result_dept_value);
$get_depart_name = $get_row['title'];
$get_dept = "select * from mst_checklist_dept dt
    inner join mst_checklist_division di on dt.dept_id = di.mas_dept_id
