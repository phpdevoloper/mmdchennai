...
while (
    ...
    ?>
            ...
            <div class="col-lg-3">
                ...
                <input type="checkbox" value="<?php echo $row['media_id'] ?>" class="subject-list" id="myCheckbox<?php echo $row['media_id'] ?>" onchange="get_mediavalueImages('<?php echo $row['alt_filename'] ?>','<?php echo $row['title'] ?>','<?php echo $row['media_id'] ?>');" />
