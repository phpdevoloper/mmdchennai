...
if ($get_status == '') {
    $get_dept = "select * from mst_checklist_dept order by position_order asc ";
} else {
    $get_dept = "select * from mst_checklist_dept where status='$get_status' order by position_order asc ";
}
