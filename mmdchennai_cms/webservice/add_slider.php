...
if ($operation == 'save') {
    ...
    if ($error != 1) {
        $query = "insert into mst_slider(title,filename,media_id,short_title,inserted_by,uploaded_on,updated_on) values('$title','$filename','$media_id','$short_title','$sessionId','$currdate','$currdate')";
