<?Php $page_name = 'acts_rules' ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="utf-8">
    <title>MMD-Chennai | Acts / Rules</title>
...
<body>
        ...
        <div class=" py-1 px-5">
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb breadcrumb_font justify-content-right mb-0">
                    ...
                    <li class="breadcrumb-item  active" aria-current="page"> <a class="" href="#">Acts / Rules</a></li>
                </ol>
            </nav>
        </div>
        <!-- <div class="py-1 px-5">
    ...
    <div class="container-fluid main_title">
        <div class=" py-3 px-5">
            <div class="one ">
                <h1 class="justify-content-left">Acts / Rules </h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <div class="row">
                                    <h4 class="text-center">Acts / Rules</h4>
                                    <div class="col-lg-2">
                                    </div>
                                    <div class="col-lg-8">
                                        <div id="get_records">
