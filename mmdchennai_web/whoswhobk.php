...
$get_dept =
    "select * from mst_whoswho_dept where status='L' order by position_order asc";
...
<head>
    <meta charset="utf-8">
    <title>MMD-Chennai | Whos Who</title>
...
<body>
        ...
        <div class=" py-1 px-5">
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb breadcrumb_font justify-content-right mb-0">
                    ...
                    <li class="breadcrumb-item  active" aria-current="page"> <a class="" href="#">Who's Who</a></li>
                </ol>
            </nav>
        </div>
        <!-- <div class="py-1 px-5">
    ...
    <div class="container-fluid main_title">
        <div class=" py-3 px-5">
            <div class="one ">
                <h1 class="justify-content-left">Who's Who </h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-6 col-xs-12">
                                ...
                                <?php
                                $get_division = "select * from mst_whoswho_dept where status='L' order by position_order asc ";
                                ...
                                if ($row_division_count != 0) {
                                    while (
                                        ...
                                        <div class="feature "  >
                                            ...
                                            //     $result_division
                                            // );
                                            $get_contents = "select * from mst_whoswho_division di 
                                                ...
                                                <div class="feature-box wow fadeInUp" data-wow-delay="0.1s" id="<?php echo $row_div['dept_id']; ?>">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-borderd data-table table table-striped table-bordered hover nowrap">
                                                            ...
                                                            <tbody>
                                                                <?Php
                                                                $divison_id = $get_row_con['div_id'];
                                                                $get_main_contents = "select * from mst_whoswho_contents di 
                                                                where  di.mas_dept_id =$get_dept_id  and mas_division_id= $divison_id and status='L' order by position_order asc
                                                                ";
                                                                $result_main_contents = pg_query($db, $get_main_contents);
                                                                $i = 0;
                                                                while ($row_contents = pg_fetch_array($result_main_contents)) {

                                                                ?>
                                                                    <tr>
                                                                        <td><?Php echo ++$i; ?></td>
                                                                        <td><?Php echo $row_contents['name']; ?></td>
                                                                        <td><?Php echo $row_contents['designation']; ?></td>
                                                                        <td><?Php echo $row_contents['email']; ?></td>
                                                                        <td><?Php echo $row_contents['phone']; ?> </td>
                                                                    </tr>
                                                                <?Php } ?>
                                                            </tbody>
                                                        </table>
