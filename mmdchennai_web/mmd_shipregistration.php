...
<body>
        ...
        <div class=" py-1 px-5">
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb breadcrumb_font justify-content-right mb-0">
                    ...
                    <li class="breadcrumb-item  active" aria-current="page"> <a class="" href="#">Ship Registration & Certification</a></li>
                </ol>
            </nav>
        </div>
        <!-- <div class="py-1 px-5">
    ...
    <div class="container-fluid main_title">
        <div class=" py-3 px-5">
            <div class="one ">
                <h1 class="justify-content-left">Ship Registration & Certification </h1>
            </div>
        </div>
    </div>
                                    ...
                                    <nav id="admin-quick" class="">
                                        <div class="adminquick-menu " style="padding-top:10px;">
                                            <div id="navbarSupportedContent">
                                                ...
                                                <div class="seven">
                                                    <h1 class="text-center">Ship Registration</h1>
                                                </div>
                                                ...
                                                <ul class="quick-1st">
                                                    ...
                                                    <?php //} ?> -->
                                                    <li><a rel="noopener" class="nav-link js-scroll-trigger" href="#" onclick="get_data(1,1)"> For Whom </a></li>
                                                    <li><a rel="noopener" class="nav-link js-scroll-trigger" href="#" onclick="get_data(1,2)">Fees</a></li>
                                                    <li><a rel="noopener" class="nav-link js-scroll-trigger" href="#" onclick="get_data(1,3)"> Supporting Documents </a></li>
